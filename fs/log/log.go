...
// Flags
var (
	logFile        = config.StringP("log-file", "", "", "Log everything to this file")
	useSyslog      = config.BoolP("syslog", "", false, "Use Syslog for logging")
	syslogFacility = config.StringP("syslog-facility", "", "DAEMON", "Facility for syslog, eg KERN,USER,...")
)
